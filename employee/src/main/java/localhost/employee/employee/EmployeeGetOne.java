 ...
 * 
 * @author Justin Moore
 * @created on 9/7/16 Class that requests particular employee
 *
 *          x
 */
...
public class EmployeeGetOne {
	...
	/**
	 * The URL of the specific employee number inserted after employee/
	 */
	protected static String endpoint = "http://localhost:1337/employee/10";
