 ...
 * 
 * @author Justin Moore
 * @created on 9/7/16 Class that updates one employee
 *
 *          x
 */
...
public class EmployeePut {
	...
	/**
	 * The URL of the employee to update
	 */
	protected static String endpoint = "http://localhost:1337/employee/15";
	...
	public static void main(String[] args) {
		...
		try {
			...
			// modifies the URL out of the endpoint, returnType and queryString
