 ...
 * 
 * @author Justin Moore
 * @created on 9/7/16 class that deletes an employee
 *
 *          x
 */
...
public class EmployeeDelete {
	...
	/**
	 * The URL of the specific employee number that will be deleted/
	 */
	protected static String endpoint = "http://localhost:1337/employee/9";
